...
import React, { useMemo, useEffect, ReactNode, RefObject } from 'react'
 ...
 * Compatible with r3f-scroll-rig for scroll-synchronized WebGL text
 */

interface WebGLTextScrollRigProps {
...
export const WebGLTextScrollRig = ({
  el,
  children,
  material,
  scale,

...
type AlienSVGProps = {
  className?: string // so you can pass Tailwind or custom classes
}

export default function AlienSVG({ className = '' }: AlienSVGProps) {
  return (
    <svg
      // Allowing Tailwind classes to control the fill via "fill-current"
      className={`fill-current ${className}`}
      version="1.0"
      xmlns="http://www.w3.org/2000/svg"
      width="946"
      height="1280"
      viewBox="0 0 946 1280"
      preserveAspectRatio="xMidYMid meet"
    >
      <g
        transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)"
        fill="currentColor" // uses text color or "fill-current"
        stroke="none"
      >
        <path
          d="M4445 12789 c-643 -46 -1269 -212 -1820 -484 -571 -282 -1045 -673
